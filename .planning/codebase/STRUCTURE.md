...
├── package.json                   # Node.js dependencies (Slidev)
...
│   ├── audit/                     # Audit logging
│   ├── generationEngine/          # Slidev integration
...
├── themes/                        # Presentation themes (Slidev)
...
- Key files: `courseService.go`, `generationRoutes.go` (async generation), Markdown writers (Slidev)
...
- Purpose: Course presentation generation via Slidev
- Contains: Docker-based generator for Slidev
- Subdirectories: slidev_integration/
...
- Source: Auto-generated by the Slidev engine
...
**themes/**
- Purpose: Presentation themes for Slidev
