...
func BenchmarkOffsetPagination_FirstPage(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		_, _, err := repo.GetAllEntities(BenchmarkEntity{}, 1, 20, map[string]interface{}{}, nil)
		if err != nil {
...
func BenchmarkOffsetPagination_Page250(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		_, _, err := repo.GetAllEntities(BenchmarkEntity{}, 250, 20, map[string]interface{}{}, nil)
		if err != nil {
			b.Fatalf("Error: %v", err)
		}
	}
...
func BenchmarkOffsetPagination_Page500(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		_, _, err := repo.GetAllEntities(BenchmarkEntity{}, 500, 20, map[string]interface{}{}, nil)
		if err != nil {
			b.Fatalf("Error: %v", err)
		}
	}
...
func BenchmarkSequentialTraversal_Offset(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		for page := 1; page <= 50; page++ {
			_, _, err := repo.GetAllEntities(BenchmarkEntity{}, page, 20, map[string]interface{}{}, nil)
			if err != nil {
