...
func (m *mockTerminalTrainerService) GetUserTerminalUsage(userID string, orgID *uuid.UUID) (*dto.MyTerminalUsageResponse, error) {
	panic("not implemented")
}
...
func (m *mockTerminalTrainerService) EnrichSessionOptionsBudget(opts *dto.SessionOptionsResponse, plan *paymentModels.SubscriptionPlan, userID string) {
}
