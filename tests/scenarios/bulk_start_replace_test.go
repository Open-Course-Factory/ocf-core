...
func (m *mockTTService) EnrichSessionOptionsBudget(*ttDto.SessionOptionsResponse, *paymentModels.SubscriptionPlan, string) {
}
...
func TestBulkStartScenario_ReplacesExistingActiveSessions(t *testing.T) {
	...
	result, err := dashSvc.BulkStartScenario(groupID, scenario.ID, services.ScenarioProvisioning{}, 0, "")
