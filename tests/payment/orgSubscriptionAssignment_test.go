...
func seedOrgAndTwoPlans(t *testing.T, db *gorm.DB) (
	...
	freePlan = seedPlan(t, db, models.SubscriptionPlan{Name: "FreeAssignTest", GroupManagementEnabled: true})
	// free-priced so the service marks it active immediately
	proPlan = seedPlan(t, db, models.SubscriptionPlan{Name: "ProAssignTest", Priority: 20, GroupManagementEnabled: true})
